...
./orgchart -data "$(pwd)/data/people/Anura Kumara Dissanayake/2024-09-23/" -type person
...
./orgchart -data "$(pwd)/data/people/Anura Kumara Dissanayake/2024-09-25/" -type person
